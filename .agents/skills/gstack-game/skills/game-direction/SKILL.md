...
Direction Review:
  ...
  Next Step:
    PRIMARY: /game-eng-review — direction set, validate technical feasibility
    (if mode = PIVOT): /game-ideation — start over with new direction
    (if mode = SHELVE): none — project shelved, no next step
